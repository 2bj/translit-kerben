...
abc2['a'] = new Array ('я','Я','Я','я','Я','йа','я','Йа','а','a');
...
abc2['o'] = new Array ('ё','Ё','Ё','ё','Ё','ё','Йо','йо','о','o');
 
tra['ö'] = new Array ('','');
abc2['ö'] = new Array ('ө','ö');
 
tra['h'] = new Array ('сх+','Сх+','з+','Сх','с+','ш+','Ц+','Ш+','С+','сх','ц+','З+','Ш','с','ц','ш','З','С','Ц','з','','');
abc2['h'] = new Array ('схх','Схх','зх','Щ','сх','шх','Цх','Шх','Сх','щ','цх','Зх','Щ','ш','ч','щ','Ж','Ш','Ч','ж','ң','h');
...
abc2['u'] = new Array ('ю','Ю','Ю','ю','Ю','йу','ю','Йу','у','u');
...
tra['ü'] = new Array ('','');
abc2['ü'] = new Array ('ү','ü');
 
tra['q'] = new Array ('','');
abc2['q'] = new Array ('ө','q');

tra['ı'] = new Array ('','');
abc2['ı'] = new Array ('ы','ı');

tra['ç'] = new Array ('','');
abc2['ç'] = new Array ('ч','ç');

tra['ş'] = new Array ('','');
abc2['ş'] = new Array ('ш','ş');

tra['A'] = new Array ('Ы+','Й+','Ы','Й','','');
abc2['A'] = new Array ('Я','Я','Я','ЙА','А','A');
...
abc2['O'] = new Array ('Ё','Ё','Ё','ЙО','О','O');
 
tra['Ö'] = new Array ('','');
abc2['Ö'] = new Array ('Ө','Ö');
 
tra['H'] = new Array ('СХ+','Ц+','СХ','С+','З+','Ш+','Ш','Ц','С','З','','');
abc2['H'] = new Array ('СХХ','ЦХ','Щ','СХ','ЗХ','ШХ','Щ','Ч','Ш','Ж','Ң','H');
...
abc1['м'] = 'm';
abc1['н'] = 'n';
abc1[String.fromCharCode(1187)] = 'h';
abc1['о'] = 'o';
abc1[String.fromCharCode(1257)] = 'q';
abc1['п'] = 'p';
abc1['р'] = 'r';
abc1['с'] = 's';
abc1['т'] = 't';
abc1['у'] = 'u';
abc1[String.fromCharCode(1199)] = 'w';
abc1['ф'] = 'f';
abc1['х'] = 'x';
abc1['ц'] = 'c';
abc1['ч'] = 'ch';
...
abc1['М'] = 'M';
abc1['Н'] = 'N';
abc1[String.fromCharCode(1186)] = 'H';
abc1['О'] = 'O';
abc1[String.fromCharCode(1256)] = 'Q';
abc1['П'] = 'P';
abc1['Р'] = 'R';
abc1['С'] = 'S';
abc1['Т'] = 'T';
abc1['У'] = 'U';
abc1[String.fromCharCode(1198)] = 'W';
abc1['Ф'] = 'F';
abc1['Х'] = 'H';
abc1['Ц'] = 'C';
abc1['Ч'] = 'Ch';
...
function changelanguage()
{
	if (!translit) {
		translit=1;
		document.getElementById("btnChangeLang").value="Кыргызча";
	}
	else {
		translit=0;
		document.getElementById("btnChangeLang").value="Latin"; 
	}
...
{
	translit=1; 
	document.getElementById("btnChangeLang").value = translit==1?'Latin':'Кыргызча';
	setfoc();
	return false;
}
...
{	
	...
	document.getElementById("txtcount").innerText = txtt.replace(/\r/g,'').length;
	document.getElementById("txtcount").textContent = txtt.replace(/\r/g,'').length; 
	return false;
}
...
function translate_letter(evnt)
{
	...
	if (processhtmltags&&(txt=='<')) {
		pretranslit=translit; setcharset1();
	}
	if (processhtmltags&&(txt=='>')) {
...
{
	tra['h'] = new Array ('сх+','Сх+','з+','Сх','с+','ш+','Ц+','Ш+','С+','сх','ц+','З+','Ш','с','ц','ш','З','С','Ц','з','','');
	abc2['h'] = new Array ('схх','Схх','зх','Щ','сх','шх','Цх','Шх','Сх','щ','цх','Зх','Щ','ш','ч','щ','Ж','Ш','Ч','ж',String.fromCharCode(1187),'h');
...
{
	tra['h'] = new Array ('сх+','Сх+','з+','Сх','с+','ш+','Ц+','Ш+','С+','сх','ц+','З+','Ш','с','ц','ш','С','Ц','','');
	abc2['h'] = new Array ('схх','Схх','зх','Щ','сх','шх','Цх','Шх','Сх','щ','цх','Зх','Щ','ш','ч','щ','Ш','Ч',String.fromCharCode(1187),'h');

	tra['j'] = new Array ('','');
	abc2['j'] = new Array ('ж','j');
}
	...
	if (lat)
	{
		for (var ii=0; ii<lat.length; ii++)
		{
			...
			{
				return pretxt.substr(0,pretxt.length-lat[ii].length)+kyr[ii];
			}
		}
	}
	return txt;
